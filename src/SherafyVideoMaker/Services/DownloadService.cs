...
namespace SherafyVideoMaker.Services
{
    public class DownloadService
    {
        ...
        public async Task<string> DownloadAsync(ProjectSettings settings, Action<double> reportProgress, Action<string> log)
        {
            ...
            using var response = await _httpClient.GetAsync(settings.ClipUrl, HttpCompletionOption.ResponseHeadersRead);
            ...
            var fileName = GetFileName(response.Content.Headers.ContentDisposition, settings.ClipUrl);
